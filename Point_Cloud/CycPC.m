function [FscoreCyc, spDivRIr, PercCyc] = CycPC
...
%% Cyc
CycIndex = TrainVal_labelsPC == 2; % binary index for Cyc labels
dmCyc = TrainVal_Remove_MIN_MAX_RI_PC(CycIndex);
predictCyc = TrainVal_predictPC(CycIndex); predictCyc = predictCyc == 2;
gtCyc = TrainVal_labelsPC(CycIndex); gtCyc = gtCyc == 2;
